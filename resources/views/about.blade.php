            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-9">
                    <div class="section-title mb-4">
                        <h2 class="title">Real Life. <span class="text-primary"> Real Knowledge.</span> Real People.</h2>
                        <p class="lead">Smart is an acronym for Specific, Measurable, Realistic and Time Sensitive.</p>
                        <p class="mb-0">The first thing to remember about success is that it is a process – nothing more, nothing less. There is really no magic to it and it’s not reserved only for a select few people. As such, success really has nothing to do with luck,
                            coincidence or fate. It really comes down to understanding the steps in the process and then executing on those steps.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3 mb-4 mb-lg-0">
                    <div class="counter">
                        ...
                        <div class="counter-content">
                            <span class="timer text-white" data-to="200" data-speed="10000">1790</span>
                ...
                <div class="col-sm-6 col-lg-3 mb-4 mb-lg-0">
                    <div class="counter">
                        ...
                        <div class="counter-content align-self-center">
                            <span class="timer text-white" data-to="75" data-speed="10000">245</span>
                ...
                <div class="col-sm-6 col-lg-3 mb-4 mb-md-0">
                    <div class="counter">
                        ...
                        <div class="counter-content">
                            <span class="timer text-white" data-to="30" data-speed="10000">491</span>
                            <label class="text-white">Professor</label>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="counter">
                        ...
                        <div class="counter-content">
                            <span class="timer text-white" data-to="30" data-speed="10000">1090</span>
